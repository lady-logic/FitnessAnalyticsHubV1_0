...
namespace FitnessAnalyticsHub.WebApi.Controllers
{
    ...
    public class PredictionController : ControllerBase
    {
        ...
        public async Task<ActionResult<PredictionResultDto>> PredictPerformance(int athleteId, string sportType)
        {
            try
            {
                var prediction = await _predictionService.PredictPerformanceAsync(athleteId, sportType);
        ...
        public async Task<ActionResult<bool>> IsModelTrained(int athleteId)
        {
            try
            {
                var isTrained = await _predictionService.IsModelTrainedForAthleteAsync(athleteId);
                return Ok(isTrained);
            }
            catch (Exception ex)
            {
